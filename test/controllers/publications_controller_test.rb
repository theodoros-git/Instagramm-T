...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { content: @publication.content, image: @publication.image } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { content: @publication.content, image: @publication.image } }
